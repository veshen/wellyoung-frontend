...
import '../../css/app/themeSales.scss';
...
class ThemeSales extends Component {
    constructor(props){
        super(props);
        this.listData = [
            {
    ...
    render(){
        ...
        return (
            <div className='themeSales'>
                <Header />
                <div className='banner'><img src='' /></div>
                <div className='glist'>
                    <PageIntro title='主题花束' desc='简介包涵一小段简介；一张图片（图片自动获取主题花束页最新上架的产品的图片）' />
